...
export async function getElectionResults(
  ...
  const res = await axiosClient.get<ElectionResultResponse>(
    `${API_URLS.ELECTION.GET_RESULTS}/${election_id}/results`
  );
  return res.data;
}
...
export async function createPosition(
  ...
  const res = await axiosClient.post<PositionResponse>(
    `${API_URLS.ELECTION.CREATE_POSITION}/${election_id}/positions`,
    payload
  );
  return res.data;
}
...
export async function getPositions(
  ...
  const res = await axiosClient.get<PositionResponse[]>(
    `${API_URLS.ELECTION.GET_POSITIONS}/${election_id}/positions`
  );
  return res.data;
}
...
export async function createCandidate(
  ...
  const res = await axiosClient.post<CandidateResponse>(
    `${API_URLS.ELECTION.CREATE_CANDIDATE}/${position_id}/candidates`,
    payload
  );
  return res.data;
}
...
export async function getCandidates(
  ...
  const res = await axiosClient.get<CandidateResponse[]>(
    `${API_URLS.ELECTION.GET_CANDIDATES}/${position_id}/candidates`
  );
  return res.data;
}
...
export async function addVoters(
  ...
  const res = await axiosClient.post<BulkVoterUploadResponse>(
    `${API_URLS.ELECTION.ADD_VOTERS}/${election_id}/voters`,
    { voters }
  );
  return res.data;
}
...
export async function getVoters(
  ...
  const res = await axiosClient.get<EligibleVoterResponse[]>(
    `${API_URLS.ELECTION.GET_VOTERS}/${election_id}/voters`
  );
  return res.data;
}
